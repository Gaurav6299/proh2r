...
@Component({
  selector: 'app-publish-pay-slip',
  templateUrl: './publish-pay-slip.component.html',
  styleUrls: ['./publish-pay-slip.component.scss']
})
export class PublishPaySlipComponent implements OnInit, AfterViewInit {
  ...
  publishedPayslipFunction() {
    ...
    if (this.selectedRows.length == 0) {
      ...
      const dialogRef = this.dialog.open(EmployeePublishDialogComponent, {
        width: '500px',
...
@Component({
  templateUrl: 'employee-payslip-publish-dialog-component.html',
  styleUrls: ['./dialog.scss']
})
export class EmployeePublishDialogComponent {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<EmployeePublishDialogComponent>,
