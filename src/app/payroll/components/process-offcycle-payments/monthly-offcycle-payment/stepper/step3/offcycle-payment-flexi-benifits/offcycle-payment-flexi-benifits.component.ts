...
@Component({
  selector: 'app-offcycle-payment-flexi-benifits',
  templateUrl: './offcycle-payment-flexi-benifits.component.html',
  styleUrls: ['./offcycle-payment-flexi-benifits.component.scss']
})
export class OffcyclePaymentFlexiBenifitsComponent implements OnInit, AfterViewInit {

  @Input() public uploadVariablePaysEmployeeList;
  public variableAllowanceForm: FormGroup;

  dataSource = new MatTableDataSource<Element>(ELEMENT_DATA);
  displayedColumns = ['select', 'employeeCode', 'employeeName', 'reimburableAmount', 'recordId'];
  ...
  onClickReimbursableAmountDialog(data: any) {
    ...
    const dialogRef = this.dialog.open(OffcyclePaymentsReimbursableAmountComponent, {
      width: '700px',
...
export class OffcyclePaymentsReimbursableAmountComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<OffcyclePaymentsReimbursableAmountComponent>,
